...
const LOCAL_STORAGE_KEY = "LineaA3-color-data";

const LineaA3: React.FC = () => {
...
useEffect(() => {
  axios.get(`${import.meta.env.VITE_BACKEND_URL}/Corporalia/v1/carreteras/carretera/A3`)
    .then((res) => {
      setData(res.data);
