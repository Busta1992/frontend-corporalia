...
const LOCAL_STORAGE_KEY = "LineaA6-color-data";

const LineaA6: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_BACKEND_URL}/Corporalia/v1/carreteras/carretera/A6`
      );
      ...
      toast.error("Error al cargar los datos de A6.");
    }
  };
