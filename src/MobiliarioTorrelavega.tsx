...
const LOCAL_STORAGE_KEY = "MobiliarioTorrelavega-color-data";

const MobiliarioTorrelavega: React.FC = () => {
...
useEffect(() => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/Corporalia/v1/mobiliario/municipio/Torrelavega`);
...
console.log("✅ DISPONIBLES TOTALES:", disponibles.map(r => r.codigo));
  ...
  <div style={containerStyle}>
    ...
    <h2 style={titleStyle}>Torrelavega</h2>
...
{[
  ...
  const coincideMunicipio = filterMunicipio === "Todos" || r.municipio === filterMunicipio || (!r.municipio && filterMunicipio === "Torrelavega");
...
export default MobiliarioTorrelavega
