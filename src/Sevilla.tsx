...
const LOCAL_STORAGE_KEY = "Sevilla-color-data";

const Sevilla: React.FC = () => {
...
useEffect(() => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/Corporalia/v1/BBDD/provincia/Sevilla`);
      ...
      const formattedData: Row[] = response.data.map((row: any) => {
        ...
        return {
          ...
          municipio: row.municipio?.trim() || "Sevilla",
          provincia: row.provincia || "",
          observaciones: row.observaciones || "",
      ...
      toast.error("Error al cargar los datos de Sevilla.");
    }
  };
...
console.log("✅ DISPONIBLES TOTALES:", disponibles.map(r => r.codigo));
  ...
  <div style={containerStyle}>
    ...
    <h2 style={titleStyle}>Sevilla</h2>
